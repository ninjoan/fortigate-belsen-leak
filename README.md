# Análisis de Leak de Datos de Fortigate (Belsen Group)
...
Este repositorio sirve como un recurso para:

* Investigadores de seguridad que estudian el impacto del `CVE-2022-40684`.
* Organizaciones que necesitan verificar si sus sistemas fueron afectados.
* Concienciar sobre la importancia de la aplicación oportuna de parches de seguridad.
...
> **Nota Importante:** Esta información se proporciona únicamente con fines de investigación de seguridad defensiva. Los datos ya han sido divulgados públicamente y se comparten para ayudar a las organizaciones a evaluar su exposición y tomar las medidas de remediación necesarias.
